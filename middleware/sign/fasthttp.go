...
// ============================================================================
// Dynamic Fasthttp Middleware (hot-reload)
// ============================================================================

// VerifyRequestFasthttpDynamic is like VerifyRequestFasthttp but reads config
// from a DynamicRequestVerifyConfig on every request.
func VerifyRequestFasthttpDynamic(dynCfg *DynamicRequestVerifyConfig, hdr HeaderNames) func(fasthttp.RequestHandler) fasthttp.RequestHandler {
	h := hdr.Effective()
...
// SignResponseFasthttpDynamic is like SignResponseFasthttp but reads config
// from a DynamicServerSignConfig on every request.
func SignResponseFasthttpDynamic(dynCfg *DynamicServerSignConfig, hdr HeaderNames) func(fasthttp.RequestHandler) fasthttp.RequestHandler {
	h := hdr.Effective()
