...
import (
	...
	echoAdapter "github.com/bufgot/web/engine/echo"
)

func main() {
	// Create Echo adapter and router via unified interface
...
func helloHandler(ctx web.Context) error {
	return ctx.JSON(http.StatusOK, map[string]string{"message": "Hello from Echo!"})
}
