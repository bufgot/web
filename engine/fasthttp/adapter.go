...
// Request 返回HTTP请求 (构建一个http.Request对象)
...
// Param 获取路径参数 (fasthttp不支持路径参数，需要简单实现)
func (c *FasthttpContext) Param(name string) string {
	// 简单实现，实际项目中可能需要路由匹配库来支持路径参数
	return ""
}
